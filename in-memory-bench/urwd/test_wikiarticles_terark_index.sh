nohup dstat -tcm --output /home/panfengfeng/trace_log_2/in-memory/wikiarticles/readwritedel_terark_index_256 2 > nohup.out &
...
date
export TerarkDb_WrSegCacheSizeMB=256
../../db_wikiarticles_terark_index --benchmarks=readwritedel --num=$record_num --reads=$read_num --sync_index=1 --threads=12 --db=$dirname --resource_data=$file
free -m
date
echo "####terark benchmark finish"
du -s -b $dirname
