nohup dstat -tcm --output /home/panfengfeng/trace_log_2/in-memory/pagecounts/readwritedel_rocksdb_256_256 2 > nohup.out &
...
free -m
date
../db_pagecounts_rocksdb --benchmarks=readwritedel --num=$record_num --reads=$read_num --write_buffer_size=$writebuffer --cache_size=$cachesize --bloom_bits=5 --db=$dirname --use_existing_db=1 --threads=12 --resource_data=$file
free -m
date
echo "####rocksdb benchmark finish"
du -s -b $dirname
