nohup dstat -tcm --output /home/panfengfeng/trace_log_2/on-disk/wikiarticles/fillrando_mulit_wiredtiger_no_lsm_1024_over 2 > nohup.out &
...
free -m
date
../db_wikiarticles_wiredtiger_overwrite --benchmarks=fillrandom --num=$record_num --reads=$read_num --db=$dirname --use_lsm=0 --cache_size=$cachesize --resource_data=$file --threads=3
free -m
date
du -s -b $dirname
echo "####wiredtiger benchmark finish"
