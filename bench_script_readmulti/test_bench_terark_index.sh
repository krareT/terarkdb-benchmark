...
../db_bench_terark_index --benchmarks=fillrandom --value_size=$value --num=$record_num --reads=$read_num --sync_index=0 --db=$dirname
free -m
date
...
date
export NarkDb_WrSegCacheSizeMB=64
../db_bench_terark_index --benchmarks=readrandom --value_size=$value --num=$record_num --reads=$read_num --sync_index=0 --threads=4 --db=$dirname
free -m
date
echo "####terark benchmark finish"
du -s -b $dirname
