...
free -m
date
../db_wikiarticles_wiredtiger_overwrite --benchmarks=fillrandom --num=$record_num --reads=$read_num --db=$dirname --use_lsm=0 --cache_size=$cachesize --resource_data=$file --threads=8
free -m
date
du -s -b $dirname
echo "####wiredtiger benchmark finish"
...
free -m
date
../db_wikiarticles_wiredtiger_overwrite --benchmarks=fillrandom --num=$record_num --reads=$read_num --db=$dirname --use_lsm=0 --cache_size=$cachesize --resource_data=$file --threads=16
free -m
date
du -s -b $dirname
echo "####wiredtiger benchmark finish"
