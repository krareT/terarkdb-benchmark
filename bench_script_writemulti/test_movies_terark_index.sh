nohup dstat -tcm --output /home/panfengfeng/trace_log_2/in-memory/movies/fillrandom_mulit_terark_index_256_4g 2 > nohup.out &
...
date
export NarkDb_WrSegCacheSizeMB=256
../db_movies_terark_index --benchmarks=fillrandom --num=$record_num --reads=$read_num --sync_index=0 --db=$dirname --resource_data=$file --threads=12
free -m
date
du -s -b $dirname
echo "####terarkdb benchmark finish"
