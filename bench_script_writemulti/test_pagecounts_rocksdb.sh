...
free -m
date
../db_pagecounts_rocksdb --benchmarks=fillrandom --num=$record_num --reads=$read_num --write_buffer_size=$writebuffer --cache_size=$cachesize --bloom_bits=5 --db=$dirname --resource_data=$file --threads=8
free -m
date
echo "####rocksdb benchmark finish"
du -s -b $dirname
...
free -m
date
../db_pagecounts_rocksdb --benchmarks=fillrandom --num=$record_num --reads=$read_num --write_buffer_size=$writebuffer --cache_size=$cachesize --bloom_bits=5 --db=$dirname --resource_data=$file --threads=16
free -m
date
echo "####rocksdb benchmark finish"
du -s -b $dirname
