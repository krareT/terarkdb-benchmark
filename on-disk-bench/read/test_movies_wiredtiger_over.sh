nohup dstat -tcmd -D sdc --output /home/panfengfeng/trace_log/on-disk/movies/readrandom2_wiredtiger_no_lsm_512m_over_95_mem8g_details_readnum_40000000_loop1 2 > nohup.out &
