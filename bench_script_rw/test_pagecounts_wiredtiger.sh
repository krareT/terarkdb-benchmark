nohup dstat -tcm --output /home/panfengfeng/trace_log_2/in-memory/pagecounts/readwhilewriting_wiredtiger_no_lsm_256_append 2 > nohup.out &
...
free -m
date
../db_pagecounts_wiredtiger --benchmarks=readwhilewriting --num=$record_num --reads=$read_num --db=$dirname --use_lsm=0 --cache_size=$cachesize --use_existing_db=1 --threads=8 --resource_data=$file
free -m
date
echo "####wiredtiger benchmark finish"
du -s -b $dirname
