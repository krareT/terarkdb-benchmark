nohup dstat -tcm --output /home/panfengfeng/trace_log_2/in-memory/pagecounts/readwhilewriting_terark_index_256_4g_old 2 > nohup.out &
...
date
export TerarkDb_WrSegCacheSizeMB=256
../db_pagecounts_terark_index --benchmarks=readwhilewriting --num=$record_num --reads=$read_num --sync_index=0 --db=$dirname --threads=8 --resource_data=$file
free -m
date
echo "####terarkdb benchmark finish"
du -s -b $dirname
