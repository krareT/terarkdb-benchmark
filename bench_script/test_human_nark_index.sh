...
date
export NarkDb_WrSegCacheSizeMB=64
../db_humangenome_nark --benchmarks=readrandom --num=$record_num --reads=$read_num --sync_index=0 --db=$dirname --threads=8 --resource_data=$file
free -m
date
echo "####narkdb benchmark finish"
du -s -b $dirname
...
date
export NarkDb_WrSegCacheSizeMB=64
../db_humangenome_nark --benchmarks=readrandom --num=$record_num --reads=$read_num --sync_index=0 --db=$dirname --threads=16 --resource_data=$file
free -m
date
echo "####narkdb benchmark finish"
du -s -b $dirname
...
date
export NarkDb_WrSegCacheSizeMB=64
../db_humangenome_nark --benchmarks=readrandom --num=$record_num --reads=$read_num --sync_index=0 --db=$dirname --threads=24 --resource_data=$file
free -m
date
echo "####narkdb benchmark finish"
du -s -b $dirname
