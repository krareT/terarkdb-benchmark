...
date
export NarkDb_WrSegCacheSizeMB=64
../db_bench_nark_index --benchmarks=readrandom --value_size=$value --num=$record_num --reads=$read_num --sync_index=0 --threads=8 --db=$dirname
free -m
date
echo "####nark benchmark finish"
du -s -b $dirname
...
date
export NarkDb_WrSegCacheSizeMB=64
../db_bench_nark_index --benchmarks=readrandom --value_size=$value --num=$record_num --reads=$read_num --sync_index=0 --threads=16 --db=$dirname
free -m
date
echo "####nark benchmark finish"
du -s -b $dirname
...
date
export NarkDb_WrSegCacheSizeMB=64
../db_bench_nark_index --benchmarks=readrandom --value_size=$value --num=$record_num --reads=$read_num --sync_index=0 --threads=24 --db=$dirname
free -m
date
echo "####nark benchmark finish"
du -s -b $dirname
