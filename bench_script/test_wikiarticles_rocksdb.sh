...
free -m
date
../db_wikiarticles_rocksdb --benchmarks=readrandom --num=$record_num --reads=$read_num --write_buffer_size=$writebuffer --cache_size=$cachesize --bloom_bits=5 --db=$dirname --use_existing_db=1 --threads=24 --resource_data=$file
free -m
date
echo "####rocksdb benchmark finish"
du -s -b $dirname
