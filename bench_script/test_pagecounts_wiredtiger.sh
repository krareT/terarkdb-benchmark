...
free -m
date
../db_pagecounts_wiredtiger --benchmarks=readrandom --num=$record_num --reads=$read_num --db=$dirname --use_lsm=0 --cache_size=$cachesize --use_existing_db=1 --threads=24 --resource_data=$file
free -m
date
echo "####wiredtiger benchmark finish"
du -s -b $dirname
