...
free -m
date
../db_bench_rocksdb_new --benchmarks=readwritedel --value_size=$value --num=$record_num --reads=$read_num --write_buffer_size=$writebuffer --cache_size=$cachesize --bloom_bits=5 --db=$dirname --use_existing_db=1 --threads=12
free -m
date
echo "####rocksdb benchmark finish"
du -s -b $dirname
